...
The filter relies on a number of assumptions about the inputs to the:
\begin{enumerate}
	\item The state transition probability $p(x_t | u_t,x_{t-1})$ is a linear function with added Gaussian noise, expressed as:
		\begin{equation}
